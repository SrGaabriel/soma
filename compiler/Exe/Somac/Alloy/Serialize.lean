...
inductive SerializableInst where
  ...
  | stackClosure (funcRef : SerializableFuncRef) (env : SerializableOperand)
...
def instToSerializable : Inst n → SerializableInst
  ...
  | .stackClosure fr e => .stackClosure (funcRefToSerializable fr) (sop e)
  | .stackClosurePoly fr ta e => .stackClosurePoly (funcRefToSerializable fr) (stys ta) (sop e)
...
def instFromSerializableN (n : Nat) : SerializableInst → Inst n
  ...
  | .stackClosure fr e => .stackClosure (funcRefFromSerializable fr) (dop e)
  | .stackClosurePoly fr ta e => .stackClosurePoly (funcRefFromSerializable fr) (dtys n ta) (dop e)
