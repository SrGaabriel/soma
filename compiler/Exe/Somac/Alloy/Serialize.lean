...
inductive SerializableInst where
  ...
  | reuseTaggedLit (tag : Nat) (payload : Array SerializableOperand)
      (reuse : SerializableOperand) (ty : SerializableTy)
  ...
  | makeClosurePoly (funcRef : SerializableFuncRef) (tyArgs : Array SerializableTy)
      (captureCount : Nat) (env : SerializableOperand)
  | makeClosure (funcRef : SerializableFuncRef) (captureCount : Nat) (env : SerializableOperand)
  | makeClosureDyn (fnClosure : SerializableOperand) (captureCount : Nat)
      (env : SerializableOperand) (ty : SerializableTy)
  | stackClosure (funcRef : SerializableFuncRef) (captureCount : Nat) (env : SerializableOperand)
  | stackClosurePoly (funcRef : SerializableFuncRef) (tyArgs : Array SerializableTy)
      (captureCount : Nat) (env : SerializableOperand)
...
def instToSerializable : Inst n → SerializableInst
  ...
  | .reuseTaggedLit t p r ty => .reuseTaggedLit t (sops p) (sop r) (sty ty)
  ...
  | .makeClosurePoly fr ta cc e => .makeClosurePoly (funcRefToSerializable fr) (stys ta) cc (sop e)
  | .makeClosure fr cc e => .makeClosure (funcRefToSerializable fr) cc (sop e)
  | .makeClosureDyn fn cc e ty => .makeClosureDyn (sop fn) cc (sop e) (sty ty)
  | .stackClosure fr cc e => .stackClosure (funcRefToSerializable fr) cc (sop e)
  | .stackClosurePoly fr ta cc e => .stackClosurePoly (funcRefToSerializable fr) (stys ta) cc (sop e)
...
def instFromSerializableN (n : Nat) : SerializableInst → Inst n
  ...
  | .reuseTaggedLit t p r ty => .reuseTaggedLit t (dops p) (dop r) (dty n ty)
  ...
  | .makeClosurePoly fr ta cc e =>
      .makeClosurePoly (funcRefFromSerializable fr) (dtys n ta) cc (dop e)
  | .makeClosure fr cc e => .makeClosure (funcRefFromSerializable fr) cc (dop e)
  | .makeClosureDyn fn cc e ty => .makeClosureDyn (dop fn) cc (dop e) (dty n ty)
  | .stackClosure fr cc e => .stackClosure (funcRefFromSerializable fr) cc (dop e)
  | .stackClosurePoly fr ta cc e =>
      .stackClosurePoly (funcRefFromSerializable fr) (dtys n ta) cc (dop e)
