...
/* Override pool size - much smaller */
#undef GRAPH_NODE_POOL_SIZE
#define GRAPH_NODE_POOL_SIZE (1 << 20)  /* 1M nodes = 16MB per runtime */
...
int main(int argc, char** argv) {
    ...
    printf("Separate runtimes (small pools): %d × fib(%d), %d workers\n\n", count, fib_n, nworkers);
